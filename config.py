class Config:
    ...
    test_dir = r'D:\py_pro\11、test'
    class_name = ("WhitehairedBanshee", "UndeadSkeleton", "WhitehairedMonster", "SlurryMonster",
    ...
    center_variance = 0.1   # 对中心坐标给与更大的loss权重
    size_variance = 0.2     # 对预测框的长宽给与更大的loss权重
