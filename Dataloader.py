...
class BatchSampler_Our(Sampler):
    ...
    def __init__(self, sampler, batch_size, max_iteration=150, drop_last=True):
        """
...
def Our_Dataloader(dataset,batch_size,shuffle=True,num_workers=2,drop_last=True,max_iteration=150):
    if shuffle:
